            ...
            <CardContent className="p-8">
              ...
              <div className="grid md:grid-cols-4 gap-6 text-center">
                ...
                <div className="bg-white/50 rounded-lg p-4">
                  ...
                  <h4 className="font-semibold mb-2">Derinlik Havuzu</h4>
                  <p className="text-sm text-muted-foreground">7 seviye unilevel komisyonu</p>
                </div>
                <div className="bg-white/50 rounded-lg p-4">
              ...
              <div className="mt-6 text-center">
                <div className="inline-block bg-white/50 rounded-lg p-4">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between text-sm">
                      <span>Derinlik Havuzu (%15):</span>
                      <span className="text-cyan-500 font-medium">
                        ${Math.round(selectedProduct.price * 0.15)}
                      </span>
                    </div>
                    <div className="flex items-center justify-between text-sm">
                      <span>Monoline Havuzu (%10):</span>
                      <span className="text-purple-500 font-medium">
                        ${Math.round(selectedProduct.price * 0.10)}
                      </span>
                    </div>
                    <div className="flex items-center justify-between text-sm">
                      <span>Sistem Fonu (%50):</span>
                      <span className="text-muted-foreground">
                        ${Math.round(selectedProduct.price * 0.50)}
                      </span>
                    </div>
                  </div>
